...
Participates in deterministic replay using the existing Replay Registry.

---

# Observability Model

Publishes distributed traces, metrics, structured logs, and execution telemetry through the existing observability platform.
